...
<?php print "<table align=\"center\">
   <tr>
     <td><center><font size=\"3\" face=\"Arial, Helvetica, sans-serif\"><strong>"._MD_CHAT_CHAT."</strong></font></center></td>
   </tr>
   <tr>
 ...
 <PARAM NAME=movie VALUE=\"count_users.swf?browser="; echo $browser; print "\"><PARAM NAME=menu VALUE=false><PARAM NAME=\"quality\" VALUE=\"best\"><PARAM NAME=\"wmode\" VALUE=\"transparent\"><EMBED src=\"count_users.swf?browser="; echo $browser; print "\" WIDTH=\"475\" HEIGHT=\"20\" align=\"baseline\" menu=\"false\" quality=\"best\" wmode=\"transparent\" TYPE=\"application/x-shockwave-flash\" PLUGINSPAGE=\"http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash\" swLiveConnect=\"true\"></EMBED>
   ...
   <tr>
     <td align=\"center\"><form name=\"chat_entra\" action=\"chatflash.php\" method=\"POST\" onSubmit=\"check_chat_entra();return document.return_the_value\">
...
print "</table>
   ...
   <tr>
     <td>
		<table style=\"width:'190px'; border:'border-width:1px' 'border-style:solid' 'color:#333333'\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"odd\">
  <tr>
    <td class=\"odd\"><input type=\"submit\" name=\"Submit\" value=\""._MD_CHAT_POP1."\" style=\"'font-size:small'; 'font-family:Arial, Helvetica, sans-serif'; 'cursor:hand';\"  onClick=\"MM_openBrWindow('index_popup.php','chatflash','resizable=yes,scrollbars=yes,width=600,height=500')\">
      <span style=\"'font-size:small'; 'font-family:Arial, Helvetica, sans-serif'; font-weight: bold;\">"._MD_CHAT_POP2."</span><br>
    <span style=\"'font-size:x-small'; 'font-family:Arial, Helvetica, sans-serif'; \">"._MD_CHAT_POP3."</span></td>
  </tr>
</table><br><br>
    ...
    </table><br><br><table  align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
         <tr>
           <td valign=\"top\"><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"1\">
             <ul>
   ...
   <tr>
     <td align=\"center\"><hr noshade size=\"1\">
      <font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"1\">"._MD_CHAT_HEL1." <a href=\"javascript:MM_openBrWindow('help.php','Help','toolbar=no,scrollbars=no,width=492,height=198')\">"._MD_CHAT_HEL2."</a>.</font><br>
<br>
<br>
Desarrollado por: <a href=\"http://www.miguanajuato.com\" target=\"xoopsmx\">Mi Guanajuato</a> y <a href=\"http://www.neoideas.net\" target=\"xoopsmx\">Neoideas.net</a></td>
   </tr>
 </table>"; 
