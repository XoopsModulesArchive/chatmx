...
define("_MI_CHAT_DESC", "Een chatmodule met flash en php.");
define("_MI_CHAT_BNAME", "Toegang tot de chat");
define("_MI_CHAT_BDESC", "Chat Block");

// menu admin
define("_MI_CHAT_ADMENU0", "Gebruikers Admin");
