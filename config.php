...
// Ajustes del chat
$url="".XOOPS_URL."/modules/chatmx/"; //url absoluta del directorio donde se encuentran los scripts
...
$words_to_filter = array("mierda", "joder", "follar", "jodan", "gilipollas", "capullo", "puto","puta", "pinche", "chinga", "wey", "culo", "verga", "cabron",);//lista de palabrotas para filtar, pon las que quieras
